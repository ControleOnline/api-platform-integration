...
- Em `Food99`, o weekly settlement deve considerar `service_fee` do payload bruto e a taxa logistica calibrada da integracao. A calibracao atual e `commission=7.9%`, `payment_processing=3.2%`, `logistics=60%` com piso de `R$ 4,50`.
